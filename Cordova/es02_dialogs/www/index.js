...
//N.B.: Nel document.ready NON posso mettere le funzioni richaimate da HTML
// Le righe 5,6 e 7 in questo caso sono effimere 
$(document).ready(function() {
  document.addEventListener('deviceready', function() { //usata solo se uso sensori, aspetta che il plugin si agganci ad essi
  })
})

	function showAlert(){
		navigator.notification.alert( //alert più completa da visualizzare
