...
function writeCookie(res, token){
    //HttpOnly - fare in modo che i cookie non sia accessibile da javascript
    //           ma solo da http
    //Secure - accesso solo con https
    //SameSite - il token viene reso visibile anche per richieste
    //           provenienti da pagine non inviate dal server
